...
import { deleteImages, editData } from "../../utils/api.js";
...
function EditBlog() {
  ...
  const handleSubmit = (e) => {
    ...
    editData(`/api/blog/${context?.isOpenFullScreen?.id}`, formFields).then((res) => {
  ...
  return (
    <section className="p-5 bg-gray-50">
      <form className="form py-1 p-1 md:p-8 md:py-1" onSubmit={handleSubmit}>
        <div className="sscroll max-h-[72vh] overflow-y-scroll pr-1 md:pr-4 pt-4">
